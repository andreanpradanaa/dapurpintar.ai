  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center py-12 text-ink-700 bg-white-000 border border-steel-200 rounded-xl">
        <p className="text-lg">Shopping list generation coming soon.</p>
        <p className="text-sm text-steel-400 mt-1">AI will generate shopping lists from your meal plans.</p>
      </div>
    </div>
  );
}
